...
if st.button("Predict"):
    ...
    # AI Advice
    if risk == "Low Risk":
        ai_advice = "Maintain healthy lifestyle, regular exercise, balanced diet."
    elif risk == "Medium Risk":
        ai_advice = "Consult your doctor, monitor cholesterol and blood pressure."
    else:
        ai_advice = "Immediate doctor consultation recommended. Follow medical advice strictly."
    ...
    elements.append(Paragraph(f"AI Advice: {ai_advice}", styles["Normal"]))
    doc.build(elements)
    buffer.seek(0)
    ...
    try:
        ...
        for p in probs:
            if p < 0.3:
                ...
                advice.append("Consult doctor")
            else:
                advice.append("Immediate consultation")
        df["AI Advice"] = advice
